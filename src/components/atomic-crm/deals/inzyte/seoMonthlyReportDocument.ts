...
export const getCustomerReportReadiness = ({
  ...
  if (customerFacingText(nextSteps).length < 20) {
    reasons.push("concrete aandachtspunten voor komende maand");
  }
...
export const buildSeoMonthlyReportText = ({
  ...
  return [
    ...
    "Focus voor komende maand",
    customerFacingText(nextSteps),
    "Toelichting: de cijfers tonen de ontwikkeling tussen twee kalendermaanden. Externe factoren kunnen het resultaat mede beïnvloeden.",
  ]
    .filter(Boolean)
    .join("\n\n");
};
...
@page{size:A4;margin:13mm 14mm 14mm}*{box-sizing:border-box}html{background:#eef2f0}body{font-family:Arial,Helvetica,sans-serif;color:var(--ink);margin:0;line-height:1.5;background:#fff;-webkit-print-color-adjust:exact;print-color-adjust:exact}main{max-width:900px;margin:0 auto;padding:0}.topbar{height:7px;background:linear-gradient(90deg,var(--accent),#a4ec52 62%,#d7f5ba);border-radius:0 0 8px 8px}.brand-row{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:20px 0 18px;border-bottom:1px solid var(--line)}.brand-wrap{display:flex;align-items:center;min-height:32px}.logo{display:block;width:205px;height:auto}.brand-fallback{display:none;color:var(--dark);font-size:22px;font-weight:800}.neutral-brand{color:var(--dark);font-weight:800;text-transform:uppercase;letter-spacing:.12em}.report-label{font-size:10px;font-weight:800;letter-spacing:.16em;text-transform:uppercase;color:var(--muted)}.hero{padding:25px 0 21px;display:grid;grid-template-columns:1.4fr .6fr;gap:24px;align-items:end}.eyebrow{color:#328300;text-transform:uppercase;letter-spacing:.13em;font-size:10px;font-weight:800;margin:0 0 7px}.hero h1{font-size:31px;line-height:1.08;color:var(--dark);margin:0}.client{font-size:16px;font-weight:700;margin-top:8px}.period-card{background:var(--soft);border-left:4px solid var(--accent);border-radius:10px;padding:13px 15px}.period-card strong,.period-card span{display:block}.period-card strong{font-size:13px;color:var(--dark)}.period-card span{font-size:10px;color:var(--muted);margin-top:3px}.summary{background:var(--dark);color:#fff;border-radius:16px;padding:20px 22px;margin-bottom:22px;break-inside:avoid}.summary .eyebrow{color:#a9ed68}.summary h2{font-size:18px;margin:0 0 8px}.summary p{font-size:12px;margin:0 0 8px;color:#f0f6f3}.summary p:last-child{margin-bottom:0}.section-title{display:flex;align-items:end;justify-content:space-between;gap:14px;margin:22px 0 9px}.section-title h2{font-size:18px;color:var(--dark);margin:0}.section-title span{font-size:10px;color:var(--muted)}.metrics{display:grid;grid-template-columns:repeat(2,1fr);gap:9px}.metric{position:relative;border:1px solid var(--line);border-radius:12px;padding:12px 13px;break-inside:avoid;background:#fff}.metric-top{display:flex;justify-content:space-between;gap:8px}.metric span,.metric small{font-size:10px;color:var(--muted)}.metric strong{display:block;color:var(--dark);font-size:23px;line-height:1.1;margin:6px 0 2px}.metric em{font-size:10px;font-style:normal;font-weight:800;border-radius:999px;padding:2px 6px}.metric .good{color:#2f7d14;background:#edf9e8}.metric .bad{color:#b42318;background:#fff0ee}.metric .neutral{color:var(--muted);background:#f1f3f2}.metric-kind{font-size:9px;text-transform:uppercase;letter-spacing:.08em;color:#328300;font-weight:800;margin-top:7px}.content-grid{display:grid;grid-template-columns:1fr 1fr;gap:11px;margin-top:22px}.content{border:1px solid var(--line);border-radius:14px;padding:16px 17px;break-inside:avoid}.content.work{border-top:4px solid var(--accent)}.content.next{background:var(--soft);border-color:#cfe9c1}.content h2{font-size:16px;color:var(--dark);margin:0 0 8px}.content p{font-size:11px;margin:0 0 8px}.content p:last-child{margin-bottom:0}.note{font-size:9px;line-height:1.45;color:var(--muted);margin-top:18px;padding:9px 11px;background:#f5f7f6;border-radius:8px}footer{display:flex;justify-content:space-between;gap:16px;margin-top:20px;padding-top:10px;border-top:1px solid var(--line);font-size:9px;color:var(--muted)}footer strong{color:var(--dark)}
...
<section class="content-grid"><article class="content work"><h2>Wat we deze maand hebben uitgevoerd</h2>${paragraphs(workSummary)}</article><article class="content next"><h2>Focus voor komende maand</h2>${paragraphs(nextSteps)}</article></section>
<div class="note">De cijfers tonen de ontwikkeling tussen twee kalendermaanden. Seizoensinvloeden, campagnes en andere externe factoren kunnen het resultaat mede beïnvloeden.</div>
