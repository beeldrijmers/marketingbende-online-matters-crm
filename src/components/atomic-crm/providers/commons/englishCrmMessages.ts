export const englishCrmMessages = {
  resources: {
    ...
    deals: {
      ...
      fields: {
        client_updated_at: "Client informed",
        name: "Name",
        description: "Description",
        company_id: "Company",
        ...
        proposal_valid_until_helper:
          "After this date the deal needs a decision",
        duration: "Duration",
        stage: "Stage",
      },
      action: {
  ...
  crm: {
    ...
    dashboard: {
      ...
      update_moments: {
        ...
        subtitle: "At delivery of a project and at the monthly close.",
        month: "monthly update %{month}",
        ready: "delivered",
        done: "closed",
        waiting: "%{count} days",
        more: "%{count} more to update",
      },
      workload: {
    ...
    profile: {
      personal_connection:
        "This account only (%{name}). Colleagues connect their own account; nobody else can see or use this connection.",
      gmail: {
        title: "Gmail",
        description:
