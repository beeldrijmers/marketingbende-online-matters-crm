  ...
  resources: {
    ...
    deals: {
      ...
      workflow: {
        ...
        proposal_expired: "Voorstel verlopen",
        stalled: "Blijft liggen",
      ...
      fields: {
        ...
        proposal_sent_at: "Voorstel verstuurd",
        proposal_valid_until: "Voorstel geldig tot",
        proposal_valid_until_helper:
          "Na deze datum vraagt de opdracht om een besluit",
        duration: "Looptijd",
        stage: "Fase",
      },
      action: {
