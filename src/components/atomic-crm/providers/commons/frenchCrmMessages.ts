  ...
  resources: {
    ...
    deals: {
      ...
      fields: {
        ...
        proposal_sent_at: "Proposition envoyée",
        proposal_valid_until: "Proposition valable jusqu'au",
        proposal_valid_until_helper:
          "Passé cette date, le dossier demande une décision",
        duration: "Durée",
        stage: "Étape",
      },
      action: {
