...
export const Ready = () => (
  <div className="flex flex-col h-screen">
    <div className="flex-1 flex flex-col bg-primary text-primary-foreground text-center justify-center items-center">
      <ScanFace className="w-32 h-32 mb-4" />
      <h1 className="text-3xl mb-4">Welkom bij shadcn-admin-kit</h1>
      <div className="text-lg opacity-75">
        Uw applicatie is correct geconfigureerd.
        <br />
        Voeg nu een &lt;Resource&gt; toe als child van
        &lt;Admin&gt;&lt;/Admin&gt;
      </div>
    </div>
